        ...
        <header class="fixed inset-x-0 top-0 z-50 bg-white shadow-md">
            <nav class="flex items-center justify-between p-4 lg:px-8">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <a href="/" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">Beranda</a>
                    <a href="/#about" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">tentang</a>
                    <a href="/#services" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">Layanan</a>
                    <a href="/#prices" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">Harga</a>
                    <a href="/#products" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">Produk</a>
                    <a href="/#galeri" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">Galeri</a>
                    <a href="/#contact" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">Kontak</a>
                </div>
